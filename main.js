...
module.exports = __webpack_require__(/*! C:\Users\Anshul\Documents\Angular\learn\src\main.ts */"zUnb");
...
TestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TestComponent, selectors: [["app-test"]], decls: 7, vars: 4, consts: [["type", "test", "value", "lala", 3, "id"]], template: function TestComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" Hero ", ctx.name, " ");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TestComponent, [{
    ...
    <h2>{{getName()}}</h2>
    <h2>{{location}}</h2>
      <input [id] ="myID" type="test" value=lala>
